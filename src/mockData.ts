...
export const ENHANCED_RANDOM_EVENTS: SystemEvent[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        text: "抗拒询问：向财务和室长试探性申请生活补助：『室长，我兜里连回清潭洞的轻轨票钱都不够了...』",
        popularityEffect: 0,
        reputationEffect: -5,
        energyEffect: -5,
        ...
        stressEffect: 10,
        managerChange: -15,
        outcomeText: "室长冷漠地看了你一眼：『呀，现在还在背债期，谁不是这么过来的？』但在你再三恳求下，他极其不耐烦地签发了月度『极简餐食贷款福利』，给你卡里划了 ₩150万。但这笔钱会自动作为练习生负债叠加在账单最后。经纪人看你的眼神变得有些刻薄。"
      }
    ]
  },
  {
    ...
    choices: [
      ...
      {
        text: "摇下车窗：不顾经纪人阻拦大声喝斥，指责对方已经严重触犯红线！",
        popularityEffect: 18,
        reputationEffect: -15,
        energyEffect: -5,
        moneyEffect: 0,
